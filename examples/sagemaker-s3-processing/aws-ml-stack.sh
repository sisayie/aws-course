...
TEMPLATE_URL="${TEMPLATE_URL:-https://raw.githubusercontent.com/sisayie/aws-course/refs/heads/main/cloudformation/sagemaker-s3-processing.yml}"
...
TEMPLATE_FILE="$TEMP_DIR/template.yml"
